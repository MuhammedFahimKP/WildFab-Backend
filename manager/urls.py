...
urlpatterns = [
    ...
    path('product-variations/<uuid:pk>/' , view=views.GetVarationsForProduct.as_view(),name='admin-product-variations'),
    path('varation/<uuid:pk>/',view=views.GetSingleProductVariatonImages.as_view(),name='get-admin-vartion'),
    path('varation/sizes/<uuid:pk>/',view=views.GetPerticualerSizesOfColor.as_view(),name="get-admin-sizes"),
    ...
    path('dashboard-data/<str:year>/<str:month>/',view=views.MonthlySalesView.as_view(),name='dashboard-data')
