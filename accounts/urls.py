...
urlpatterns = [
    ...
    path('get-cart-wishllist-count/',views.GetUserCartAndWishlistCountAPIView.as_view(),name='view'),
    path('signout/',views.BlackListTokenView.as_view()),
    path('google/',views.GoogleUserSiginAPIView.as_view()),
    path('activation/',views.UserActivaionApiView.as_view(),name="activate"),
